...
Original file is located at
    https://colab.research.google.com/drive/1gH_-yKd9FZVmDHBTOeXTabpISonmVkQz
"""
...
!streamlit run BrainTumor_app.py & npx localtunnel --port 8501
